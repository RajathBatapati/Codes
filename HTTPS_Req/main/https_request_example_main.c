...
#define WEB_SERVER "sep2-test.flexibleexport.com.au"
#define WEB_PORT "443"
#define WEB_URL "https://sep2-test.flexibleexport.com.au:443/dcap"
...
static void https_get_request_to_local_server(const char* url)
{
    ...
    esp_tls_cfg_t cfg = {
        ...
        .clientkey_buf = (const unsigned char *) local_server_key_pem_start,
        .clientkey_bytes = local_server_key_pem_end - local_server_key_pem_start,
